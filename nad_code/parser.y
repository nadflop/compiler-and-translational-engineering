...
%type <strval> var_type string_decl id STRINGLITERAL
%type <intval> INTLITERAL
%type <floatval> FLOATLITERAL
...
string_decl: 	_STR id ASSIGNMENT str_literal TERMINATOR { $$->name($2); 
															$$->str_val($4);
														  }
;
...
%%
//Need to do a function to update the value of each id in the parser.y
//since we will loose the data if we don't do it
//Can refer to the book pdf link at page 501, function add_declarator
//or the github link add to names and add to vals
